...
import { faArrowRight, faArrowUpRightFromSquare, faBolt, faLock, faChevronRight, faGraduationCap, faCommentDots, faFileLines, faArrowUp, faBrain } from '@fortawesome/free-solid-svg-icons';
          ...
          <div className="mx-auto max-w-6xl relative z-10">
            ...
            <div className="relative grid gap-8 md:gap-12 lg:grid-cols-3">
              ...
              {steps.map(({ num, title, desc }, index) => (
                <ScrollReveal key={num} delay={index * 150} direction="up" className="relative flex flex-col items-center text-center group">
