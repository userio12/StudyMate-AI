...
import { faArrowRight, faArrowUpRightFromSquare, faBolt, faLock, faChevronRight, faGraduationCap } from '@fortawesome/free-solid-svg-icons';
              ...
              <div className="relative rounded-2xl md:rounded-[1.5rem] border border-border bg-[#0a0a0a] shadow-inner overflow-hidden aspect-video flex flex-col transform transition-transform duration-700 ease-out group-hover:scale-[1.01] group-hover:shadow-[0_0_80px_rgba(99,102,241,0.15)]">
                ...
                <div className="flex-1 flex bg-[#0a0a0a]">
                  ...
                  <div className="hidden sm:block w-64 border-r border-white/5 bg-white/[0.02] p-5">
                     <div className="h-8 w-full bg-white/5 rounded-lg border border-white/5 mb-8" />
                     <div className="space-y-4">
                       <div className="h-4 w-3/4 bg-white/5 rounded-md" />
                       <div className="h-4 w-1/2 bg-brand-500/20 border border-brand-500/30 rounded-md" />
                  ...
                  <div className="flex-1 p-6 md:p-10 flex flex-col justify-end space-y-6 relative overflow-hidden">
                     ...
                     <div className="self-start max-w-[80%] p-5 rounded-2xl rounded-tl-sm bg-white/5 border border-white/5 backdrop-blur-sm relative z-10">
                       ...
                       <div className="mt-4 flex gap-2">
                         <div className="h-6 w-16 rounded-full bg-brand-500/20 border border-brand-500/30" />
                       </div>
                     </div>
                     <div className="self-end max-w-[80%] p-5 rounded-2xl rounded-tr-sm brand-gradient shadow-lg relative z-10">
                       <div className="h-3 w-56 bg-white/40 rounded mb-3" />
                       <div className="h-3 w-40 bg-white/30 rounded" />
                     </div>
                     <div className="mt-6 h-14 w-full rounded-xl bg-white/5 border border-white/10 flex items-center px-4 relative z-10 shadow-inner">
                       <div className="h-4 w-32 bg-white/20 rounded" />
                       <div className="ml-auto h-8 w-8 rounded-lg bg-brand-500/80 flex items-center justify-center">
